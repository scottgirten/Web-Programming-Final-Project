...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = file_get_contents('sql/updateRecipe');
    $params = array(
        'recipe_id' => $recipe_id,
    ...
    //Get last added record to the recipe table
    $sql = file_get_contents('sql/getLastRecipeID.sql');
    $statement = $database->prepare($sql);
    $statement->execute();
    $recipe_id = $statement->fetchAll(PDO::FETCH_ASSOC);
      ...
      <form action="" method="POST">
        <div class="form-group label-floating has-success">
            <label class="control-label">Recipe Name</label>
                <input type="text" value="" name="recipe_name" class="form-control" />
